					...
					<div class="giohang-box3-1">
						<div class="row">
							<!-- <button class="btn-trang btn-soluong">-</button>
								...
								<button class="btn-trang btn-soluong"><a class="a-up" href="">+</a></button>
								<input type="text" class="input-soluong" value="2" style="margin-left: 5px; font-size: 14px;">
								<button class="btn-xanh btn-soluong"><a class="cart_quantity_down" href="">-</a></button>
				...
				<div class="col-md-3 giohang-box3">
					<div class="giohang-box3-1">
						<div class="row">
								<button class=" btn-trang btn-soluong">-</button>
							<input type="text" class="input-soluong" value="2" style="margin-left: 5px;">
							<button class="btn-xanh btn-soluong" style="margin-left: 5px;"><a href="#">+</a></button>
						</div>
					</div>
				</div>
				<div class="col-md-3">
